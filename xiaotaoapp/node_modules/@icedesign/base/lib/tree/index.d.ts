...
export interface NodeProps extends React.HtmlHTMLAttributes<HTMLHtmlElement> {
  /**
   * 样式类名的品牌前缀
   */
  prefix?: string;
...
export interface TreeProps extends React.HtmlHTMLAttributes<HTMLHtmlElement> {
  /**
   * 样式类名的品牌前缀
   */
  prefix?: string;
