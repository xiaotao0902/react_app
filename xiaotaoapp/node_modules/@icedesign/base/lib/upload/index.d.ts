...
export interface CoreProps extends React.HtmlHTMLAttributes<HTMLHtmlElement> {
  /**
   * 可选参数，自定义样式
   */
  style?: React.CSSProperties;
...
export interface ListProps extends React.HtmlHTMLAttributes<HTMLHtmlElement> {
  /**
   * 文件列表，数据格式请参考 文件对象
   */
...
export interface UploadProps extends React.HtmlHTMLAttributes<HTMLHtmlElement> {
  /**
   * 样式前缀
   */
  prefix: string;
