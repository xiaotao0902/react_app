...
export interface SubNavProps extends React.HtmlHTMLAttributes<HTMLHtmlElement> {
  /**
   * 样式前缀
   */
  prefix?: string;
...
export interface NavProps extends React.HtmlHTMLAttributes<HTMLHtmlElement> {
  /**
   * 样式前缀
   */
  prefix?: string;
