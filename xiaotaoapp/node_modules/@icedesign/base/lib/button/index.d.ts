...
export interface SplitProps extends React.HtmlHTMLAttributes<HTMLHtmlElement> {
  /**
   * 样式品牌前缀
   */
  prefix?: string;
...
export interface ButtonProps extends React.HtmlHTMLAttributes<HTMLHtmlElement> {
  /**
   * 组件样式的品牌前缀
   */
  prefix?: string;
